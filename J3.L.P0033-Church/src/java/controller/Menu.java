...
public class Menu extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Article topItem = null;
        ArrayList<Shared> shareList = new ArrayList<>();
        ArrayList<Article> pagingList = new ArrayList<>();
        DBContext db = null;
        int totalrow = 0;
        ...
        try {
            try {
                ...
                if (pageindex > totalpage) {
                    ...
                    pagingList = mc.getMenuList(pageindex, pagesize);
            ...
            request.setAttribute("change", "prayer");
