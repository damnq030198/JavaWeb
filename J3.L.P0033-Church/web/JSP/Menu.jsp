            ...
            <div class="inner-wrapper">
                ...
                <div class="body-container">
                    <div class="body-content">
                        <div class="body-left">
                            <div class="prayer-top-item">
                                <div class="type-church-header">
                                    <p class="menu-type-header">${requestScope.topItem.title}</p>
                                </div>
                                <div class="type-church-content">
                                    <p class="content">
                                        ${requestScope.topItem.shortContent}
                                    </p>
                                </div>
                            </div>
                            <div class="prayer-list">
                                <c:if test="${(error == false ? false : true)}">
                                    <c:forEach var="pl" items="${requestScope.pagingList}" >
                                        <div class="type-church-header">
                                            <a href="menuItem?id=${pl.id}" class="menu-type-header">${pl.title}</a>
                                        </div>
                                        <div class="type-church-content">
                                            <p class="content">
                                                <img id="type-img-detail" alt="" src="${pl.imgLink}">
                                                ${pl.fullContent}
                                            </p>
                                        </div>
                                    </c:forEach>
